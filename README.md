...
회원권 거래소 여섯 곳의 시세를 매일 자동 수집해 차트 시각화, 목표가 도달 시 실시간 WebSocket 알림. 구독(월 49,000원 / 299,000원)으로 전체 기간 데이터 및 관심 종목 무제한.
...
Scheduler (매일 07:00)
  └── Jsoup 크롤링 (동부회원권, 동아골프, 시세닷컴, 에이스회원권, 프리미엄회원권, 회원권 쿨거래)
...
**시세 수집**  
Jsoup으로 여섯 소스 크롤링. 프리미엄회원권·회원권 쿨거래는 기존 종목과 정확히 매칭되는 시세만 저장해 단일 출처 신규 종목 증가를 방지.
